...
/**
 * Enables a buyer and seller in a transactional relationship to send messages to 
 * each otherwithin 90 days of the creation of the transaction. The sale does not 
 * have to be ended tomake this request. 
 *
