<?php
/**
 * Netresearch_Magebid_Block_Adminhtml_Profile_Edit_Tabs
 *
...
*/
class Netresearch_Magebid_Block_Adminhtml_Profile_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    /**
     * Construct
     *
    ...
    {
        parent::__construct();		
        $this->setId('magebid_profile_edit_tabs');
    ...
    protected function _beforeToHtml()
    {
        $this->addTab('profile', array(
            ...
            'content'   => $this->getLayout()->createBlock('magebid/adminhtml_profile_edit_tab_profile')->toHtml(),
            'active'    => true,
        ));
        ...
        $this->addTab('payment', array(
            ...
            'title'     => Mage::helper('magebid')->__('Payment Methods'),
   			'content'   => $this->getLayout()->createBlock('magebid/adminhtml_profile_edit_tab_payment')->toHtml(),
        ));
		
        $this->addTab('shipping', array(
            'label'     => Mage::helper('magebid')->__('Shipping Methods'),
            'title'     => Mage::helper('magebid')->__('Shipping Methods'),
    		'content'   => $this->getLayout()->createBlock('magebid/adminhtml_profile_edit_tab_shipping')->toHtml(),
        ));		
        ...
        $this->addTab('policy', array(
            ...
            'content'   => $this->getLayout()->createBlock('magebid/adminhtml_profile_edit_tab_policy')->toHtml(),
        ));							

        $this->addTab('layout', array(
            'label'     => Mage::helper('magebid')->__('Layout'),
            'title'     => Mage::helper('magebid')->__('Layout'),
    		'content'   => $this->getLayout()->createBlock('magebid/adminhtml_profile_edit_tab_layout')->toHtml(),
        ));		
