<?php
/**
 * Netresearch_Magebid_Block_Adminhtml_Profile_New_Tab_Policy
 *
...
*/
class Netresearch_Magebid_Block_Adminhtml_Profile_New_Tab_Policy extends Mage_Adminhtml_Block_Widget_Form
{
    /**
     * Prepare Form
     *
