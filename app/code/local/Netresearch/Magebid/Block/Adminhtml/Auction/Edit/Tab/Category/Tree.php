<?php
/**
 * Netresearch_Magebid_Block_Adminhtml_Auction_Edit_Tab_Category_Tree
 *
...
*/
class Netresearch_Magebid_Block_Adminhtml_Auction_Edit_Tab_Category_Tree extends Mage_Adminhtml_Block_Catalog_Category_Tree
{
    /**
     * Construct
     *
