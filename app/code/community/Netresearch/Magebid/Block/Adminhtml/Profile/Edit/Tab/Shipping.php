<?php
/**
 * Netresearch_Magebid_Block_Adminhtml_Profile_Edit_Tab_Shipping
 *
...
*/
class Netresearch_Magebid_Block_Adminhtml_Profile_Edit_Tab_Shipping extends Mage_Adminhtml_Block_Widget_Form
{
    /**
     * Prepare Form
     *
    ...
    protected function _prepareForm()
    {
        ...
        $form->getElement('shipping_method')->setRenderer(
            $this->getLayout()->createBlock('magebid/adminhtml_profile_edit_tab_shipping_method')
        );   	
