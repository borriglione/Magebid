<?php
/**
 * Netresearch_Magebid_Block_Adminhtml_Profile_Edit_Tab_Profile
 *
...
*/
class Netresearch_Magebid_Block_Adminhtml_Profile_Edit_Tab_Profile extends Mage_Adminhtml_Block_Widget_Form
{
    /**
     * Prepare Form
     *
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('profile_name', 'text', array(
            'name'      => 'profile_name',
            'title'     => Mage::helper('magebid')->__('Name'),
