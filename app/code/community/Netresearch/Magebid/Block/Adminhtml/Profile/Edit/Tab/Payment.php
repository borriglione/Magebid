<?php
/**
 * Netresearch_Magebid_Block_Adminhtml_Profile_Edit_Tab_Payment
 *
...
*/
class Netresearch_Magebid_Block_Adminhtml_Profile_Edit_Tab_Payment extends Mage_Adminhtml_Block_Widget_Form
{
    /**
     * Prepare Form
     *
    ...
    protected function _prepareForm()
    {
        ...
        $form->getElement('payment_method')->setRenderer(
            $this->getLayout()->createBlock('magebid/adminhtml_profile_edit_tab_payment_method')
        );       
