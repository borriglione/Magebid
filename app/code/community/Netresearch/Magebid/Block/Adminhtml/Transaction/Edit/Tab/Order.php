<?php
/**
 * Netresearch_Magebid_Block_Adminhtml_Transaction_Edit_Tab_Order
 *
...
*/
class Netresearch_Magebid_Block_Adminhtml_Transaction_Edit_Tab_Order extends Mage_Adminhtml_Block_Widget_Form
{	
    /**
     * Prepare Form
     *
