<?php
/**
 * Mbid_Magebid_Model_Mysql4_Import_Policy_Collection
 *
 * @category  Mbid
...
*/
class Mbid_Magebid_Model_Mysql4_Import_Policy_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract
{
    /**
     * Construct
     *
