<?php
/**
 * Mbid_Magebid_Block_Adminhtml_Auction_Edit_Tab_Policy
 *
 * @category  Mbid
...
*/
class Mbid_Magebid_Block_Adminhtml_Auction_Edit_Tab_Policy extends Mage_Adminhtml_Block_Widget_Form
{
    /**
     * Prepare Form
     *
