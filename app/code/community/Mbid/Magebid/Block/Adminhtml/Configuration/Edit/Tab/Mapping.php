<?php
/**
 * Mbid_Magebid_Block_Adminhtml_Configuration_Edit_Tab_Mapping
 *
 * @category  Mbid
...
*/
class Mbid_Magebid_Block_Adminhtml_Configuration_Edit_Tab_Mapping extends Mage_Adminhtml_Block_Widget_Form
{
    /**
     * Construct
     *
