...
*/
class Mbid_Magebid_Block_Adminhtml_Configuration_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    /**
     * Construct
     *
    ...
    public function __construct()
    {
        ...
        $this->setTitle(Mage::helper('magebid')->__('Import and Mapping'));        
    }
