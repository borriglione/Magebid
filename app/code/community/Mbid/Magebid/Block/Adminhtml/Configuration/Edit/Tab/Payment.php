<?php
/**
 * Mbid_Magebid_Block_Adminhtml_Configuration_Edit_Tab_Payment
 *
 * @category  Mbid
...
*/
class Mbid_Magebid_Block_Adminhtml_Configuration_Edit_Tab_Payment extends Mage_Adminhtml_Block_Widget
{	
    /**
     * Construct
     *
