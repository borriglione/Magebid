<?php
/**
 * Mbid_Magebid_Block_Adminhtml_Profile_Edit_Tab_Layout
 *
 * @category  Mbid
...
*/
class Mbid_Magebid_Block_Adminhtml_Profile_Edit_Tab_Layout extends Mage_Adminhtml_Block_Widget_Form
{
    /**
     * Prepare Form
     *
