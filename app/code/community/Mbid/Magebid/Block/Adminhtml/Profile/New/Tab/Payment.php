<?php
/**
 * Mbid_Magebid_Block_Adminhtml_Profile_New_Tab_Payment
 *
 * @category  Mbid
...
*/
class Mbid_Magebid_Block_Adminhtml_Profile_New_Tab_Payment extends Mage_Adminhtml_Block_Widget_Form
{
    /**
     * Prepare Form
     *
