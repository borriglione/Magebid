<?php
/**
 * Mbid_Magebid_Block_Adminhtml_Profile_Edit_Tab_Profile
 *
 * @category  Mbid
...
*/
class Mbid_Magebid_Block_Adminhtml_Profile_Edit_Tab_Profile extends Mage_Adminhtml_Block_Widget_Form
{
    /**
     * Prepare Form
     *
